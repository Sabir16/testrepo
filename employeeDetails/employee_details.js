const employees = [
    ...
    // ... D'autres enregistrements d'employés peuvent ajoutés ici 
];
...
function findEmployeeBySp(employeeSp) {
    ...
    document.getElementById('employeesDetails').innerHTML =`<p>${foundEmployee.id}: ${foundEmployee.name}--${foundEmployee.age} -- ${foundEmployee.department} -- ${foundEmployee.salary} --${foundEmployee.specialization}</p>`;
      ...
      document.getElementById('employeesDetails').innerHTML = 'aucun employé n\'a été trouvé avec cet Sp';
     }
}
